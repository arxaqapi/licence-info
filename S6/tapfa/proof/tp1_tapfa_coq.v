...
Fixpoint inf n m :=
  match n,m with
  | O, _ => true (* cas écheant, n inf à m *)
  | S n1, O => false (* ici nest supérieur à m*)
  | S n1, S m1 => inf n1 m1 (* déscente récursive *)
  end.
Check inf.
...
(* Q1. Qu'est-ce qu'une proposition dans Coq ?
      -> une prop est une «ligne» qui s'évalue à True ou à False
